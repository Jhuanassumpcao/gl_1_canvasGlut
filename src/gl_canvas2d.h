...
public:
    ...
    static void point(Ponto pos); //coordeandas do ponto

    static void line( float x1, float y1, float x2, float y2 ); //coordenadas da linha x1, y1, x2, y2
    static void line( Ponto p1, Ponto p2 ); //coordenadas da linha (p1, p2)
    ...
    static void rect( Ponto p1, Ponto p2 ); //coordenadas do retangulo (p1, p2) - TO DO

    static void rectFill( float x1, float y1, float x2, float y2 ); //coordenadas do retangulo x1, y1, x2, y2
    static void rectFill( Ponto p1, Ponto p2 ); //coordenadas do retangulo (p1, p2)
    ...
    static void circle( Ponto p, float radius, int div );

    static void circleFill( float x, float y, float radius, int div );
    static void circleFill( Ponto p, float radius, int div );
